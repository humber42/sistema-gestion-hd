...
BEGIN
  ...
  FOR rec IN
  SELECT unidad_organizativa, fecha_ocurrencia, concat(titulo, concat('. ',lugar)) AS sintesis,
         municipio, afectacion_usd, afectacion_servicio, concat(materiales, concat(' - ', cantidad)) AS material_afectado,
         numero_denuncia, expediente_inv_sac, sin_denuncia,
         articulo_83, articulo_82, medida_administrativa, menor_edad, expfp, pendiente_despacho, pendiente_juicio, priv_lib,
         cantidad_sancionados, sentencia
  FROM hechos
  ...
  WHERE id_tipo_hecho = 1 AND (fecha_ocurrencia BETWEEN $1 AND $2)
...
BEGIN
  ...
  FOR rec IN
  SELECT unidad_organizativa, fecha_ocurrencia, concat(titulo, concat('. ',lugar)) AS sintesis,
         municipio, afectacion_usd, afectacion_servicio, afect_tpublica, numero_denuncia, expediente_inv_sac, sin_denuncia,
         articulo_83, articulo_82, medida_administrativa, menor_edad, expfp, pendiente_despacho, pendiente_juicio, priv_lib,
         cantidad_sancionados, sentencia
  FROM hechos
         JOIN unidades_organizativas ON unidades_organizativas.id_unidad_organizativa = hechos.id_uorg
         ...
         JOIN municipios ON municipios.id_municipio = hechos.id_municipio
  WHERE id_tipo_hecho = 2 AND (fecha_ocurrencia BETWEEN $1 AND $2)
  ORDER BY fecha_ocurrencia
...
BEGIN
  ...
  FROM hechos
         JOIN unidades_organizativas ON unidades_organizativas.id_unidad_organizativa = hechos.id_uorg
  WHERE hechos.id_tipo_hecho = $1 AND unidades_organizativas.id_unidad_organizativa = $2
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_o_no(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date, esclarecido boolean)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_no_esclarecidos_sac(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_no_esclarecidos_sin_denuncia(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_art83(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_art82(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_med_admin(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_menor(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_fase_prep(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_pend_despacho(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_pend_juicio(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_hechos_esclarecidos_casos(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_sancionados_hechos_esclarecidos(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
CREATE OR REPLACE FUNCTION cant_sentencias_hechos_esclarecidos(id_tipo_hecho integer, id_uorg integer, fecha_inicio date, fecha_fin date)
  RETURNS integer AS
$BODY$
DECLARE cant integer;
BEGIN
...
BEGIN
  ...
  SELECT unidades_organizativas.unidad_organizativa,
         ...
         cant_hechos_rango(1,unidades_organizativas.id_unidad_organizativa,$1,$2) AS cant_pext,
         cant_hechos_rango(2,unidades_organizativas.id_unidad_organizativa,$1,$2) AS cant_tpub,

         cant_hechos_esclarecidos_o_no(1,unidades_organizativas.id_unidad_organizativa,$1,$2,false) +
         cant_hechos_esclarecidos_o_no(2,unidades_organizativas.id_unidad_organizativa,$1,$2,false)
                                                                                                    AS total_no_esclarecidos,

         cant_hechos_esclarecidos_o_no(1,unidades_organizativas.id_unidad_organizativa,$1,$2,false) AS cant_pext_no_esc,
         cant_hechos_esclarecidos_o_no(2,unidades_organizativas.id_unidad_organizativa,$1,$2,false) AS cant_tpub_no_esc,
         ...
         cant_hechos_esclarecidos_o_no(1,unidades_organizativas.id_unidad_organizativa,$1,$2,true) AS cant_pext_esc,
         cant_hechos_esclarecidos_o_no(2,unidades_organizativas.id_unidad_organizativa,$1,$2,true) AS cant_tpub_esc,
  ...
  WHERE hechos.numero_denuncia IS NOT NULL
    ...
    AND unidades_organizativas.unidad_organizativa LIKE '%DT%' OR unidades_organizativas.unidad_organizativa LIKE 'DVLH'
